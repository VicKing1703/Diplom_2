...
class TestNewOrder:
    ...
    @allure.title('Создание нового заказа с авторизацией и ингредиентами')
    ...
    @allure.title('Создание нового заказа с авторизацией и без ингредиентов')
    ...
    @allure.title('Создание нового заказа без авторизации и ингредиентами')
    ...
    @allure.title('Создание нового заказа с неправильным хэшом ингредиентов')
